                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding-copy">Congratulation {{ $user->username }}</td>
                                        </tr>
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">Your Username {{$user->username}} has been successfully created, <!-- Your Email Activation Is Successfully Completed, if you need support please send us email admin@erc20.io, Also follow our social media network. --></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                  ...
                  <tr>
                     <td align="center">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="scale-90" width="490">
                           <tr>
                              <td>
                                 <h1 style=" font-family: 'Ubuntu', sans-serif;">Congratulation {{ $user->username }}</h1>
                                 <br>
                           ...
                           <tr>
                              <td align="left" style="font-family: 'Ubuntu', sans-serif; font-size: 14px; color: #1c1c1c; line-height: 28px;" mc:edit="copy4">
                                 <p>
                                 <h4 style="font-weight: normal; font-size: 15px; line-height: 23px;"> Your Username {{$user->username}} has been successfully created, Your Email Activation Is Successfully Completed, if you need support please send us email admin@gmail.com, Also follow our social media network.</h4> 
                                 </p>
                              </td>
                           </tr>
                        </table>
