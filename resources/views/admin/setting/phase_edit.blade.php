    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Phase Edit</li>
            </ol>
            <div class="card">
            	<div class="card-body">
                    ...
                    <form class="form-horizontal theme-form mt-5 row" action="{{ url('admin-update-phase')}}" method="post">
                        {{csrf_field()}}
                        <input type="hidden" name="phase_id" value="{{$phase->id}}">                        
                        
                        <div class="form-group col-md-6"><label>Phase Name</label>                            
                            <input type="text" class="form-control" id="name" name="name" value="{{ $phase->name }}" style="text-transform: capitalize;">
                        ...
                        <div class="form-group col-md-6"><label>USD Price</label>                            
                            <input type="text" class="form-control" id="usd_price" name="usd_price" value="{{ $phase->usd_price }}" pattern="[0-9. ]+">
                        ...
                        <div class="form-group col-md-6"><label>Total Tokens</label>                            
                            <input type="text" class="form-control" id="sold_coins" name="sold_coins" value="{{ $phase->sold_coins }}" pattern="[0-9. ]+">
                        ...
                        <div class="form-group col-md-6"><label>Sold Tokens</label>                            
                            <input type="text" class="form-control" id="sold" name="sold" value="{{ $phase->sold }}" pattern="[0-9. ]+">
                        ...
                        <div class="form-group col-md-12"><label>Bonus</label>                            
                            <input type="text" class="form-control" id="bonus" name="bonus" value="{{ $phase->bonus }}" pattern="[0-9. ]+">
                        ...
                        <div class="form-group col-md-6"><label>Start Date :</label> 
                            <div class="input-group date" id="start_date" data-target-input="nearest">                           
                                <input type="text" class="form-control atetimepicker-input" id="start_date" name="start_date" data-target="#start_date" value="{{ $phase->start_date }}">
                        ...
                        <div class="form-group col-md-6"><label>End Date :</label>  
                            <div class="input-group date" id="end_date" data-target-input="nearest">                          
                                <input type="text" class="form-control atetimepicker-input" id="end_date" name="end_date" data-target="#end_date" value="{{ $phase->end_date }}">
